...
| Security maintenance and fork safety | \`.github/SECURITY.md\`, \`docs/security.md\`, \`docs/maintenance.md\`, \`.agents/skills/security-maintenance/SKILL.md\`, \`.agents/skills/fork-operator-onboarding/SKILL.md\`, \`pnpm test:security-maintenance\`, \`pnpm check:security-maintenance\`, abuse controls, \`pnpm check:secrets\`, \`pnpm check:docs-health\`, \`pnpm check:release-checklist\` | Covered locally |
