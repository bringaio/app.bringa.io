...
- Moderation processing: build on prepared item suggestions/flags with admin review RPCs, accept/reject/resolve actions, seen-state, history, and Telegram dedupe/mute policy. Impact: community quality without broad browser writes. Uncertainty/research: notification privacy and review-state semantics need live-project and operator review.
