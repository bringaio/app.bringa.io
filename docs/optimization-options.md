...
- Test strategy: extend focused tests beyond config generation, app-config helpers, and media policy helpers to Supabase RPC contracts and critical UI state. Impact: safer refactors. Side effect: respect the user's preference for agentic browser skills before adding browser-test packages.
