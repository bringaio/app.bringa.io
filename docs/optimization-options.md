...
- Backups: table and Storage backup script exists with optional Auth metadata export and admin-visible freshness metadata; add restore drills and encrypted retention policy. Impact: recovery confidence. Uncertainty/research: service role scope, Supabase Auth restore limits, and Storage reconciliation details need live-project verification after setup.
