...
| Supabase development branch setup | `docs/supabase-branching.md`, `pnpm test:supabase-cli`, `pnpm check:supabase-cli`, `pnpm check:supabase-branching` | Blocked until branch access works through MCP or CLI login/access token |
