...
7. If a pull request is merged, verify the head branch was deleted or document why it remains. If you merge locally or fast-forward `main`, delete the merged remote and local head branch explicitly.
