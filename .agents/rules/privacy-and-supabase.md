...
- Never expose service role keys, access tokens, private URLs, or user data in logs, screenshots, commits, docs, or chat.
...
- Any dev-mode auth bypass, impersonation, or service-role flow must be isolated to local/dev environments and impossible to enable in production by public config alone.
